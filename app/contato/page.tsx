...
export default function ContatoPage() {
  return <main className="inner-page contact-page">
    <nav className="inner-nav"><Link className="brand" href="/"><BrandMark className="brand-mark-text"/><span>SALUTAR<span className="dot">.</span></span></Link><div className="nav-links"><Link href="/">Início</Link><Link href="/sobre">Sobre nós</Link><Link href="/contato">Contato</Link></div><Link className="nav-cta" href="https://wa.me/553192288682?text=Ol%C3%A1%20Salutar%2C%20quero%20iniciar%20um%20projeto." target="_blank">Vamos conversar <ArrowUpRight size={16}/></Link></nav>
